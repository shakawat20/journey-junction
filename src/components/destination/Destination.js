    ...
    return (
        <div >
            <div>
                ...
                <div>
                    <div className="hero" style={{
                        ...
                        width: "100%",
                        height: "350px",
                        borderRadius:"25px" // Adjust this height as needed
                    }}>
                ...
                <div>
                    <div className='grid justify-center items-center lg:grid-cols-4 md:grid-cols-2 lg:mt-8 lg:mb-8 sm:grid-cols-1 sm:w-100  ' style={{ width: "100%"}}>
                        {
                            countryInfo?.card.map((y, index) =>
                                <div>

                                    <div className="card card-compact    bg-base-100 shadow-xl " style={{ height: "580px", width: "98%" }}>
                                        <figure  ><img src={y.img} alt="Shoes" className=' rounded' style={{ height: "350px", width: "130%" }} /></figure>
            ...
            <div>
                ...
                <h1 className="text-3xl font-bold mb-3 pl-10">Travel Destination</h1>
                <h1 className="cursor-pointer" onClick={openModal} style={{ fontSize: "20px", color: "white", textAlign: "center" }}>Click on this</h1>
                <div className='flex justify-center'>
                    <img
                        ...
                        style={{ width: "95%", height: "400px", borderRadius: "7px" }}
                    />
                </div>
                    ...
                    <Modal
                        style={{
                            overlay: {
                                zIndex: 1000 // Adjust this value to be higher than the z-index of your dropdown menu
                            },
                            content: {
                                zIndex: 1000,// Adjust this value to be higher than the z-index of your dropdown menu
            ...
            <div>
                <div className='lg:text-2xl lg:m-8 lg:mr-3 lg:grid-cols-2 sm:grid sm:grid-cols-1'>
                    <div>
                        ...
                        <div style={{ width: "100%", fontFamily: "Times New Roman", textAlign: "center" }}>
                            {
